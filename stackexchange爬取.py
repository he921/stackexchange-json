...
class spider():
  ...
  'Cookie': "prov=a69f8366-f84c-406c-a12e-e9f324eaa6a1; __cf_bm=vucLxommnmGYyAOCTCzKw_S8yqrWpxl_UZHlDRo6IMk-1749005621-1.0.1.1-X.eFIcffEjDLyBEV74pOyuE9Fwb5u6BSaVVqvJ.0qhVprX37HpzkNq1DPcNXLTB8md0gk6FrCtolm61n_alHTTrt6BE9YoBrjk0XEYFvPO4; _cfuvid=j7Ln1Wg0ECiSwXkmwkX0rZFq.0qo5HLwPSoYkUVnBzw-1749005621004-0.0.1.1-604800000",
        }

        self.json_file = "all_data_math.json"  # JSON 文件名
    ...
    def page_url(self, url, first_base_url):
        """处理分页URL，返回状态码"""
        try:
            response = requests.get(url,data=self.payload,  headers=self.header, proxies=self.proxy)
